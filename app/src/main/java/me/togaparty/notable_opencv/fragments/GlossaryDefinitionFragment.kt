 ...
 * Use the [GlossaryDefinitionFragment.newInstance] factory method to
...
class GlossaryDefinitionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GlossaryDefinitionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GlossaryDefinitionFragment().apply {
